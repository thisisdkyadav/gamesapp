    ...
    return (<>
        ...
        <div className="login-form-div">
              <div className="verification-message">
                ...
                <div className='waiting-message'>We've sent a verification email to {user.email}. Please check your inbox and click the link to complete your registration.</div>
